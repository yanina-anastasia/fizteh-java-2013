...
import ru.fizteh.fivt.students.elenav.storeable.MyStoreable;
import ru.fizteh.fivt.storage.structured.*;

public class StoreableTest {

    private MyStoreable row;
    ...
    public void testSetColumnAtInvalidValue() throws Exception {
