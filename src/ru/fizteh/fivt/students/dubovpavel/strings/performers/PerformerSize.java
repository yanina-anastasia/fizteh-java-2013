...
public class PerformerSize<D extends Dispatcher & StorageAccessible<Storage<MindfulDataBaseMultiFileHashMap>>> extends Performer<D> {
    ...
    public void execute(D dispatcher, Command command) {
        dispatcher.callbackWriter(Dispatcher.MessageType.SUCCESS, String.valueOf(dispatcher.getStorage().getCurrent().size()));
    }
}
