...
public class MultiFileHashMapCommands extends AbstractCommands {
    ...
    public MultiFileHashMapCommands(File curDir) {
        currentDir = curDir;
    ...
    public void use() throws Exception {
        String tableName = lexems[1];
        tableFile = currentDir.toPath().resolve(tableName).normalize().toFile();
        if (!tableFile.exists()) {
            System.out.println(tableName + " not exists");
        } else {
            if (!tableFile.isDirectory()) {
                throw new Exception(tableName + " not a directory");
            }
        ...
        try {
            ...
            while (curPointer < length) {
                ...
                if (curByte == '\0') {
                    ...
                    int currentHashCode = currentKey.hashCode();
