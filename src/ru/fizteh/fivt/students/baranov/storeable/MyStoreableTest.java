...
public class MyStoreableTest {
    ...
    public void setUp() {
        ...
        storeable = new MyStoreable(columnTypes);
    }
    ...
    public void putBigKey() {
        storeable.setColumnAt(100, null);
    }
    ...
    @Test(expected = ColumnFormatException.class)
    public void testIntColumnFormatException() {
        storeable.setColumnAt(1, "antonbaranov");
        storeable.getIntAt(1);
    }

    @Test(expected = IndexOutOfBoundsException.class)
    public void testIntOutOfBoundsException() {
    ...
    @Test(expected = ColumnFormatException.class)
    public void testStringColumnFormatException() {
        storeable.setColumnAt(2, 1000);
        storeable.getStringAt(2);
    }

    @Test(expected = IndexOutOfBoundsException.class)
    public void testStringOutOfBoundsException() {
    ...
    @Test(expected = ColumnFormatException.class)
    public void testLongColumnFormatException() {
        storeable.setColumnAt(3, true);
        storeable.getLongAt(3);
    }

    @Test(expected = IndexOutOfBoundsException.class)
    public void testLongOutOfBoundsException() {
    ...
    @Test(expected = ColumnFormatException.class)
    public void testBooleanColumnFormatException() {
        storeable.setColumnAt(4, 10.5);
        storeable.getBooleanAt(4);
    }

    @Test(expected = IndexOutOfBoundsException.class)
    public void testBooleanOutOfBoundsException() {
    ...
    @Test(expected = ColumnFormatException.class)
    public void testDoubleColumnFormatException() {
        storeable.setColumnAt(5, new Float(10.5));
        storeable.getDoubleAt(5);
    }

    @Test(expected = IndexOutOfBoundsException.class)
    public void testDoubleOutOfBoundsException() {
    ...
    @Test(expected = ColumnFormatException.class)
    public void testFloatColumnFormatException() {
        storeable.setColumnAt(1, "1000");
        storeable.getFloatAt(1);
    }

    @Test(expected = IndexOutOfBoundsException.class)
    public void testFloatOutOfBoundsException() {
