...
public class MyTableProvider implements TableProvider {
    public MyTable curTable = null;
    HashMap<String, MyTable> tables = new HashMap<String, MyTable>();
    String curDir;

    public MyTableProvider(String directory) {
    ...
    public MyTable getTable(String name) throws IllegalArgumentException, IllegalStateException {
    ...
    public Storeable deserialize(Table table, String value) throws ParseException {
        ...
        Storeable result = new MyStoreable(cols);
    ...
    public Storeable createFor(Table table) {
        ...
        MyStoreable row = new MyStoreable(columns);
        return row;
    }
    ...
    public Storeable createFor(Table table, List<?> values) throws ColumnFormatException, IndexOutOfBoundsException {
        ...
        MyStoreable raw = new MyStoreable(columns);
    ...
    public boolean open() {
        ...
        String curTableName;
        MyTable loadingTable;
        for (File table : databaseDirectory.listFiles()) {
            curTableName = table.getName();
            List<Class<?>> zeroList = new ArrayList<Class<?>>();
            curTable = new MyTable(curTableName, zeroList, this);
            loadingTable = new MyTable(curTableName, zeroList, this);
                    ...
                    for (int j = 0; j < 16; ++j) {
                        ...
                        if (currentFile.exists()) {
                            try {
                                ...
                                try {
                                    MyTableBuilder tableBuilder = new MyTableBuilder(this, loadingTable);
    ...
    private void loadTable(RandomAccessFile temp, MyTable table, int i, int j,
                           MyTableBuilder tableBuilder) throws IllegalArgumentException, IOException {
        if (temp.length() == 0) {
            return;
        }
        long nextOffset = 0;
        ...
        while (cursor < firstOffset) {
            ...
            if (i == MyTable.getDirectoryNum(key) && j == MyTable.getFileNum(key)) {
