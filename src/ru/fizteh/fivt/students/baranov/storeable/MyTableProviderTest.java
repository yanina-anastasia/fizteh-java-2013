...
public class MyTableProviderTest {
    ...
    @Test
    public void firstTestDeserializing() {
    ...
    @Test
    public void secondTestDeserializing() {
    ...
    @Test
    public void firstTestSerializing() {
        Table testTable = provider.createTable("testTable", columnTypes);
        Storeable testStoreable = provider.createFor(testTable, columnTypes);
        testStoreable.setColumnAt(0, 5);
    ...
    @Test
    public void secondTestSerializing() {
        Table testTable = provider.createTable("testTable", multiColumnTypes);
        Storeable testStoreable = provider.createFor(testTable, multiColumnTypes);
        testStoreable.setColumnAt(0, 42);
        testStoreable.setColumnAt(1, "FourtyTwo");
        testStoreable.setColumnAt(2, 42.42);
        Assert.assertEquals("<row><col>42</col><col>FourtyTwo</col><col>42.42</col></row>",
